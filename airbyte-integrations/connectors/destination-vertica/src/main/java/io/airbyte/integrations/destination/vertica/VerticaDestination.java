...
*/
  ...
  public static void main(String[] args) throws Exception {
    ...
    //new IntegrationRunner(new VerticaDestination()).run(args);
...
/*
      ...
      final VerticaSqlOperations.VersionCompatibility compatibility = mySQLSqlOperations.isCompatibleVersion(database);
      if (!compatibility.isCompatible()) {
        throw new RuntimeException(String
                .format("Your Vertica version %s is not compatible with Airbyte",
